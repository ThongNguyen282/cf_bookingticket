        ...
        <header className="p-4 dark:bg-gray-100 dark:text-gray-800 bg-opacity-40 bg-black text-white fixed w-full z-10">
            <div className="container flex justify-between h-16 mx-auto">
                ...
                <ul className="items-stretch hidden space-x-3 lg:flex">
                    <li className="flex">
                        <NavLink to="/home" className="flex items-center px-4 -mb-1  dark:border- dark:text-violet-600 dark:border-violet-600 text-white" activeClassName="border-b-1 border-white" >Home</NavLink>
                    </li>
                    <li className="flex">
                        <NavLink to="/contact" className="flex items-center px-4 -mb-1  dark:border- " activeClassName="border-b-1 border-white" >Contact</NavLink>
                    </li>
                    <li className="flex">
                        <NavLink to="/news" className="flex items-center px-4 -mb-1  dark:border-" activeClassName="border-b-1 border-white">News</NavLink>
                    </li>
                    <li className="flex">
                        <NavLink to="#" className="flex items-center px-4 -mb-1  dark:border-" activeClassName="border-b-1 border-white">Link</NavLink>
                    </li>
                </ul>
